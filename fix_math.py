...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Corrige notações LaTeX em arquivos Markdown.')
    parser.add_argument('diretorio', help='Diretório a ser processado')
    args = parser.parse_args()
    
    processar_diretorio(args.diretorio)